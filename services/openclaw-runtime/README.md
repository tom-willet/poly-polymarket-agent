...
- Support dedicated operator views: `paper`, `orders`, `fills`, `pnl`, `scorecard`, and `markets`.
- Surface richer `why` diagnostics from the latest decision cycle and recent allocator/risk rejections.
