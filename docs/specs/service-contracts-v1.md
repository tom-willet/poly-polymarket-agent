...
- Represent the latest simulated paper order state for one execution leg.

Payload:

```json
{
  "paper_order_id": "pord_01HQX...",
  "wallet_id": "paper:0xabc...",
  "order_plan_id": "plan_01HQX...",
  "decision_id": "decision_01HQX...",
  "sleeve_id": "cross_market_core",
  "market_complex_id": "cx_fed_cut_cluster",
  "market_id": "mkt_a",
  "contract_id": "ct_yes",
  ...
  "status": "open",
  "limit_price": 0.46,
  "requested_size": 43.478261,
  "filled_size": 0,
  "remaining_size": 43.478261,
  "avg_fill_price": null,
  "created_at_utc": "2026-03-06T20:00:00Z",
  "updated_at_utc": "2026-03-06T20:00:00Z"
}
```
...
- Record one simulated paper fill generated by the deterministic paper broker.

Payload:

```json
{
  "paper_fill_id": "pfill_01HQX...",
  "paper_order_id": "pord_01HQX...",
  "wallet_id": "paper:0xabc...",
  "order_plan_id": "plan_01HQX...",
  "decision_id": "decision_01HQX...",
  ...
  "fill_price": 0.47,
  "fill_size": 43.478261,
  "fill_notional_usd": 20.43,
  "fill_ts_utc": "2026-03-06T20:00:06Z"
}
```

## 22. `paper_cash_snapshot`
...
- Persist the current virtual cash state for paper execution.
...
```json
{
  ...
  "cash_balance_usd": 459.57,
  "reserved_cash_usd": 0,
  "available_cash_usd": 459.57,
  "realized_pnl_usd": 0,
  "updated_at_utc": "2026-03-06T20:00:06Z"
}
```

## 23. `paper_position_state`
...
- Persist contract-level paper inventory used to derive aggregated `position_snapshot` rows.
